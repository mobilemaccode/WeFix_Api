...
Color colortransperent = Color.fromARGB(0, 60, 13, 168);

Color colorreddark = HexColor("#C91F42");
Color colorredlightbtn = HexColor("#6759FF");
Color colorpinklight = HexColor("#6759FF");
Color pinkbtncolor = HexColor("#D95771");
Color greybg = HexColor("#A5A5A5");
Color colorText = HexColor("#333333");

Color colorGreyBackground = HexColor("#C7C7C7"); //
...
BoxBorder borderCustom() {
  return Border.all(color: colorgrey.withOpacity(0.3));
}
